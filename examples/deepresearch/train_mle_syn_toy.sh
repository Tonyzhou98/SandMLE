...
#SBATCH --output=slurm/mle_syn_qwen3_8b_rl_grpo_agent_single_node_toy.stdout
#SBATCH --error=slurm/mle_syn_qwen3_8b_rl_grpo_agent_single_node_toy.stderr
...
experiment_name="sandmle_qwen3_8b_mle_syn_single_node_toy"
