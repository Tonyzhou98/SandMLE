...
#SBATCH --job-name=mle_syn_qwen3_30b_rl_grpo_agent_single_node_filter_timeout
#SBATCH --output=slurm/mle_syn_qwen3_30b_rl_grpo_agent_single_node_filter_timeout.stdout
#SBATCH --error=slurm/mle_syn_qwen3_30b_rl_grpo_agent_single_node_filter_timeout.stderr
...
experiment_name="sandmle_qwen3_30b_mle_syn_single_node_filter_timeout"
...
export DEEPRESEARCH_API_JOB_NAME=deepresearch_api_job_qwen3_30b
