...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--synthetic",
        action="store_true",
        help="Use the synthetic dataset root (SANDMLE_SYN_DATA_ROOT).",
    )
    parser.add_argument(
        "--competition-ids",
...
if __name__ == "__main__":
    args = parse_args()
    data_root = cfg.SYN_DATA_ROOT if args.synthetic else cfg.DATA_ROOT
    ...
    if args.synthetic:
        ok_ids = _load_ok_competitions(cfg.OK_LIST)
