...
#SBATCH --job-name=mle_syn_qwen3_32b_rl_grpo_agent_single_node_filter_timeout
#SBATCH --output=slurm/mle_syn_qwen3_32b_rl_grpo_agent_single_node_filter_timeout.stdout
#SBATCH --error=slurm/mle_syn_qwen3_32b_rl_grpo_agent_single_node_filter_timeout.stderr
...
experiment_name="sandmle_qwen3_32b_mle_syn_single_node_filter_timeout"
...
export DEEPRESEARCH_API_JOB_NAME=deepresearch_api_job_qwen3_32b
...
PYTHONUNBUFFERED=1 bash -c "python3 -m examples.deepresearch.custom_train \
    ...
    actor_rollout_ref.model.path=${SANDMLE_MODEL_DIR:-Qwen}/Qwen3-32B \
