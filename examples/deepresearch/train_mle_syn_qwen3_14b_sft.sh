...
#SBATCH --job-name=mle_syn_qwen3_14b_rl_grpo_agent_sft
#SBATCH --output=slurm/mle_syn_qwen3_14b_rl_grpo_agent_sft.stdout
#SBATCH --error=slurm/mle_syn_qwen3_14b_rl_grpo_agent_sft.stderr
...
experiment_name="sandmle_qwen3_14b_mle_syn_single_node_sft"
...
export DEEPRESEARCH_API_JOB_NAME=deepresearch_api_job_qwen3_14b_sft
...
PYTHONUNBUFFERED=1 bash -c "python3 -m examples.deepresearch.custom_train \
    ...
    actor_rollout_ref.model.path=${SANDMLE_CKPT_DIR:-checkpoints}/sandmle/sandmle_qwen3_14b_mle_sft_single_node/global_step_40/huggingface \
