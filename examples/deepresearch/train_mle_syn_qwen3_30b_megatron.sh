...
#SBATCH --output=slurm/mle_syn_qwen3_30b_megatron_rl_grpo_agent_single_node_filter_timeout.stdout
#SBATCH --error=slurm/mle_syn_qwen3_30b_megatron_rl_grpo_agent_single_node_filter_timeout.stderr
...
experiment_name="sandmle_qwen3_30b_mle_syn_two_nodes_filter_timeout_megatron"
