...
#SBATCH --output=slurm/mle_syn_qwen3_8b_rl_grpo_agent_1.stdout
#SBATCH --error=slurm/mle_syn_qwen3_8b_rl_grpo_agent_1.stderr
...
experiment_name="sandmle_qwen3_8b_mle_syn"
