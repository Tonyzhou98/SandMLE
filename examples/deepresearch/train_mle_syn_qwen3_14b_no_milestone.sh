...
#SBATCH --job-name=mle_syn_qwen3_14b_rl_grpo_agent_single_node_no_milestone
#SBATCH --output=slurm/mle_syn_qwen3_14b_rl_grpo_agent_single_node_no_milestone.stdout
#SBATCH --error=slurm/mle_syn_qwen3_14b_rl_grpo_agent_single_node_no_milestone.stderr
...
experiment_name="sandmle_qwen3_14b_mle_syn_single_node_no_milestone"
...
export DEEPRESEARCH_API_JOB_NAME=deepresearch_api_job_qwen3_14b_no_milestone
...
PYTHONUNBUFFERED=1 bash -c "python3 -m examples.deepresearch.custom_train \
    ...
    actor_rollout_ref.model.path=${SANDMLE_MODEL_DIR:-Qwen}/Qwen3-14B \
