...
#SBATCH --job-name=mle_syn_qwen3_30b_rl_grpo_agent_single_node_no_milestone
#SBATCH --output=slurm/mle_syn_qwen3_30b_rl_grpo_agent_single_node_no_milestone.stdout
#SBATCH --error=slurm/mle_syn_qwen3_30b_rl_grpo_agent_single_node_no_milestone.stderr
...
export DEEPRESEARCH_API_JOB_NAME=deepresearch_api_job_qwen3_30b_no_milestone
...
PYTHONUNBUFFERED=1 bash -c "python3 -m examples.deepresearch.custom_train \
    ...
    actor_rollout_ref.model.path=${SANDMLE_MODEL_DIR:-Qwen}/Qwen3-30B-A3B-Thinking-2507 \
