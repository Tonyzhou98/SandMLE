...
#SBATCH --output=slurm/mle_syn_qwen3_14b_rl_grpo_agent_single_node_filter_timeout.stdout
#SBATCH --error=slurm/mle_syn_qwen3_14b_rl_grpo_agent_single_node_filter_timeout.stderr
...
experiment_name="sandmle_qwen3_14b_mle_syn_single_node_filter_timeout"
