...
#SBATCH --output=slurm/deepscaler_qwen3_8b_megatron_rl_grpo_agent_single_node_filter_timeout.stdout
#SBATCH --error=slurm/deepscaler_qwen3_8b_megatron_rl_grpo_agent_single_node_filter_timeout.stderr
...
MODEL_PATH=${SANDMLE_MODEL_DIR:-Qwen}/Qwen3-8B
